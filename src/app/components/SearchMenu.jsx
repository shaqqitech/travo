  ...
  return (
    <main className='w-screen p-8  flex justify-center'>
      <div className='w-full sm:w-11/12 md:w-10/12 lg:w-9/12 xl:w-8/12 2xl:w-7/12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 shadow-xl rounded-lg ring-2'>
        <div className="border-r-2 border-blue-300 py-2 flex flex-col text-start justify-center items-start px-4">
        ...
        <div className=" py-2 flex flex-col text-start justify-center items-start px-4">
